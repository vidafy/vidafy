...
namespace WebExtension
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            string csPolicy = "frame-ancestors https://code.jquery.com https://cdn.jsdelivr.net https://maxcdn.bootstrapcdn.com https://localhost:44309/ https://a5ab-117-247-182-219.in.ngrok.io" + appendURL + ";";
